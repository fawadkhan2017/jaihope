                ...
                <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-10 md:p-16 text-center relative overflow-hidden">
                    ...
                    <div className="flex flex-wrap items-center justify-center mb-12">
                        <div className="flex -space-x-4">
                            <img src="../assets/img/team-5.jpeg" alt="Member" className="w-16 h-16 rounded-full border-4 border-white shadow-sm relative z-50 object-cover" />
                            <img src="../assets/img/team-2.jpeg" alt="Member" className="w-16 h-16 rounded-full border-4 border-white shadow-sm relative z-40 object-cover" />
                            <img src="../assets/img/team-1.jpeg" alt="Member" className="w-16 h-16 rounded-full border-4 border-white shadow-sm relative z-30 object-cover" />
                            <img src="../assets/img/team-4.jpeg" alt="Member" className="w-16 h-16 rounded-full border-4 border-white shadow-sm relative z-20 object-cover" />
                            <img src="../assets/img/team-5.jpeg" alt="Member" className="w-16 h-16 rounded-full border-4 border-white shadow-sm relative z-10 object-cover" />
                        </div>
